 ...
 * One of the easiest to implement design patterns is the Null Object Pattern.
...
//before , scroll down to see fixed code
class User {
  constructor(id, name) {
    this.id = id;
    this.name = name;
...
//fixed code, for this we need to add extra class to handle null object and maintain
//all logic in inside getUser function
class User {
  constructor(id, name) {
    this.id = id;
    this.name = name;
